    ...
    static double NR2(double x1, double x4) {
        ...
        if (x1 < x4) {
            ...
            while (exit != true) {
                ...
                double x2 = x1bis - (F2(x1bis) / F2derive(x1bis));

                String sx2 = df2.format(x2);
                x2 = Double.parseDouble(sx2);
                //System.out.println("first while: " + " x1: " + x1bis + " x2: " + x2);
                results1.add(x2);
    ...
    static double[] Bisection1(double a, double b)// the interval
    {
        ...
        if (a < b) {
            ...
            } else if (y1 < 0 || y2 < 0 && y1 > 0 || y2 > 0) // if f(a)=- and f(b)=- or f(a)=+ and f(b)=+
            {
                ...
                System.out.println("this shouldn't be triggered technically ");
            }
